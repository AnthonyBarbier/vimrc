...
tags_1 = {
	names = { "1 - main", "2 -    Skype/IM    ]", 3,4,5},
	layout = { layouts[2], layouts[2], layouts[2], layouts[2], layouts[2] }
	}
tags_2 = {
	names = { "6 - E-mails", 7,8,9},
...
tags = {}
    ...
    tags[1] = awful.tag(tags_1.names, 1, tags_1.layout)
...
--vicious.register(netwidget, vicious.widgets.net, '<span color="#CC9393">D ${eth0 down_kb}</span>/<span 
--color="#7F9F7F">U ${eth0 up_kb}</span>',3)
...
-- {SSSS{{ Key bindings
globalkeys = awful.util.table.join(
    awful.key({ modkey,           }, "Left",   awful.tag.viewprev       ),
    awful.key({ modkey,           }, "Right",  awful.tag.viewnext       ),
    awful.key({ modkey,           }, "Escape", awful.tag.history.restore),
    --awful.key({ modkey,            }, "z", function() awful.util.spawn("gnome-screensaver-command --lock") end),
...
clientkeys = awful.util.table.join(
    ...
    --awful.key({ modkey,           }, "f",      fullscreens       ),
    awful.key({ modkey,           }, "m",
        function (c)
    ...
    globalkeys = awful.util.table.join(globalkeys,
        awful.key({ modkey }, "#" .. i + 9,
                  function ()
                      ...
                      awful.tag.viewonly(tags[screen_id][tag_id])
                  end),
        awful.key({ modkey, "Control" }, "#" .. i + 9,
                  function ()
                      ...
                      awful.tag.viewtoggle(tags[screen_id][tag_id])
                  end),
        awful.key({ modkey, "Shift" }, "#" .. i + 9,
                  function ()
                      ...
                      if client.focus and tags[screen_id][tag_id] then
                          awful.client.movetotag(tags[screen_id][tag_id])
                      end
                  end),
        awful.key({ modkey, "Control", "Shift" }, "#" .. i + 9,
                  function ()
                      ...
                      if client.focus and tags[screen_id][tag_id] then
                          awful.client.toggletag(tags[screen_id][tag_id])
                      end
                  end))
end
...
awful.rules.rules = {
    ...
    { rule = { class = "Skype" },
      properties = { tag = tags[1][2] },
      callback = function(c) c.urgent = true; c:emit_signal("property::urgent", true) end 
    },
    { rule = { class = "Pidgin" },
      properties = { tag = tags[1][2] },
      callback = function(c) c.urgent = true; c:emit_signal("property::urgent", true) end 
